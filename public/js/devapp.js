...
Vue.component('board-section', {
  ...
  computed: {
    ...
    hasCards: function hasCards() {
      var vm = this;
      return vm.record && vm.record.cards && Array.isArray(vm.record.cards) && vm.record.cards.length > 0;
    }
  },
  methods: {
    ...
    storeCard: function storeCard() {
      ...
      axios.post('/api/cards', vm.card).then(function (response) {
        var card = response.data; // update the dataset

        vm.record.cards.push(card);
        vm.card = null; // let the parent know about this action
    ...
    cardRemoved: function cardRemoved(card) {
      ...
      if (vm.record.cards && card && card.id) {
        ...
        vm.record.cards.splice(i, 1); // let the parent know about this action
...
/***/ "./resources/js/components/TestApp.js":
/*!********************************************!*\
  !*** ./resources/js/components/TestApp.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {

__webpack_require__(/*! ./Section */ "./resources/js/components/Section.js");
...
var app = new Vue({
  ...
  methods: {
    loadSections: function loadSections() {
      ...
      vm.loading = true;
      setTimeout(function () {
        axios.get('/api/sections').then(function (resp) {
          console.log(resp);
    ...
    saveSection: function saveSection() {
      ...
      axios.post('/api/sections', vm.section).then(function (response) {
        var section = response.data; // update the dataset
    ...
    sectionRemoved: function sectionRemoved(section) {
      var vm = this;
    ...
    updateStore: function updateStore() {
      var vm = this;
      var parsedSections = JSON.stringify(vm.sections);
...
(() => {
/*!********************************!*\
  !*** ./resources/js/devapp.js ***!
  \********************************/
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");

__webpack_require__(/*! ./components/TestApp */ "./resources/js/components/TestApp.js");
})();
